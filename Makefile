...
all: main.o scanner.o str.o syntax_analysis.o global.o symtable.o stack.o precanal.o codegen.o
	$(CC) $(CFLAGS) scanner.o main.o str.o syntax_analysis.o global.o symtable.o stack.o precanal.o codegen.o -o prg
